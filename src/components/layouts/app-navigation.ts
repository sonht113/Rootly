...
export const navigationByRole: Record<AppRole, AppNavigationItem[]> = {
  student: [
    {
      href: getRoleHomePath("student"),
      label: "Hôm nay",
      icon: LayoutDashboard,
    },
    {
      href: getRoleNotificationsPath("student"),
      label: "Thông báo",
      icon: Bell,
    },
    {
      href: getRoleClassesPath("student"),
      label: "Lớp học",
      icon: GraduationCap,
    },
    {
      href: getRoleLibraryPath("student"),
      label: "Thư viện",
      icon: BookOpenText,
    },
    {
      href: getRoleExamsPath("student"),
      label: "Kỳ thi",
      icon: ClipboardCheck,
    },
    {
      href: getRoleCalendarPath("student"),
      label: "Lịch học",
      icon: CalendarDays,
    },
    { href: "/reviews", label: "Ôn tập", icon: GraduationCap },
    {
      href: getRoleProgressPath("student"),
      label: "Tiến độ",
      icon: ChartSpline,
    },
  ...
  teacher: [
    ...
    {
      href: getRoleExamsPath("teacher"),
      label: "Kỳ thi",
      icon: ClipboardCheck,
    },
    {
      href: getRoleNotificationsPath("teacher"),
      label: "Thông báo",
      icon: Bell,
    },
    {
      href: getRoleLibraryPath("teacher"),
      label: "Thư viện",
      icon: BookOpenText,
    },
    { href: getRoleRootsPath("teacher"), label: "Gốc từ", icon: Languages },
    {
      href: getRoleCalendarPath("teacher"),
      label: "Lịch học",
      icon: CalendarDays,
    },
    {
      href: getRoleProgressPath("teacher"),
      label: "Tiến độ",
      icon: ChartSpline,
    },
